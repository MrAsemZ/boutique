...
export default function SectionWrapper({ title, titleEn, viewAllLink, children, topPadding = 60 }) {
  const { i18n } = useTranslation();
  const isArabic = i18n.language === 'ar';

  return (
    <section>
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: `${topPadding}px 24px 60px` }}>
        <div style={{
